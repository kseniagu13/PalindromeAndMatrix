...
namespace PizzaShop
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            AddItemsToShoppingCart(currentlyInStock, myShoppingCart);
            Console.WriteLine();
           ...
           /* Console.WriteLine("Choose pizza: thin or pan?");
            ...
            while (true)
            {
                ...
                if (userInput == "add")
                {
                    ...
                    if(userInputChoice=="pizza")
                    {
                        currentlyInStock.PrintInStockMenu();
                        AddItemsToShoppingCart(currentlyInStock, myShoppingCart);

                    }
                    else if(userInputChoice=="extra")
                    {
                        inStockExtras.PrintExtraMenu();
                        AddExtrasToShoppingCart(inStockExtras, extrasShoppingCart);
                    }
        ...
        public static void AddItemsToShoppingCart(Menu currentlyInStock, MyShoppingCart shoppingcart) //see ei ole meetod, sest ei ole seotud objektiga
        {
